        ...
        <span class="hidden sm:inline-block sm:align-middle sm:h-screen"></span>
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">    
                <div class="px-4 py-3 border-b border-gray-200">
                    <h2 class="text-xl font-semibold text-gray-600 text-center font-bold">SERVICIO</h2>
                </div>
                <form> 
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mb-4">
                            <label for="caracteristicas" class="block text-gray-700 text-sm font-bold mb-2">Características</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="caracteristicas" wire:model="caracteristicas">
                        </div>
                        ...
                        <div class="mb-4">
                            <label for="tiempo" class="block text-gray-700 text-sm font-bold mb-2">Tiempo del servicio</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="tiempo" wire:model="tiempo">
                        </div>
