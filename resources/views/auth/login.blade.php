                ...
                <div class="col-lg-5 col-md-8 align-item-center">
                    <div class="border">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            @csrf
                            <fieldset class="p-4">
                                <input type="email" placeholder="Correo electrónico" class="border p-3 w-100 my-2" name="email" :value="old('email')" required autofocus>
                                <input type="password" placeholder="Contraseña" class="border p-3 w-100 my-2" name="password" required autocomplete="current-password">
